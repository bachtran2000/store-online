...
//    Tạo biến config chứa các thông tin cần thiết cho phân trang
  public $params = [
    ...
    'query_additional' => '' //chứa chuỗi query từ url nếu có, ví dụ như khi search theo name,
      // thì biến này sẽ có giá trị là &name=abc chẳng hạn, để đảm bảo phân trang hoạt động đúng
  ...
  public function __construct($params = [])
  {
    ...
    if (isset($this->params['query_additional']) && !empty($this->params['query_additional'])) {
      $query_additional = "&" . $this->params['query_additional']; // (1) => "&&name=$_GET['name']" (2)
    }
    ...
    // (2) => full_url = ...&action=...&&name=$_GET['name']...
  }
